        ...
        <div className="bg-gradient-to-br from-gray-900 to-black border border-gray-800 rounded-3xl p-12 hover:border-red-600/50 transition-all duration-500 shadow-2xl">
          <div className="text-center mb-8">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-red-600/10 border border-red-600/30 rounded-full mb-4">
              ...
              <span className="text-sm text-red-400 font-semibold">Bize Ulaşın</span>
            </div>
            
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-4">
              İletişimde <span className="text-transparent bg-clip-text bg-gradient-to-r from-red-500 to-rose-600">Kalın</span>
            </h2>
            
            <p className="text-gray-400 text-lg">
              E-posta adresinizi bırakın, özel teklifler ve güncellemeler için sizinle iletişime geçelim
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="max-w-xl mx-auto">
            ...
            {/* Status Messages */}
            {status === 'success' && (
              <div className="mt-4 flex items-center gap-2 text-green-500 bg-green-500/10 border border-green-500/30 rounded-lg p-4">
                <CheckCircle size={20} />
                <span>{message}</span>
              </div>
            )}
            ...
            {status === 'error' && (
              <div className="mt-4 flex items-center gap-2 text-red-500 bg-red-500/10 border border-red-500/30 rounded-lg p-4">
                <AlertCircle size={20} />
                <span>{message}</span>
              </div>
            )}
          ...
          <div className="mt-12 pt-12 border-t border-gray-800 text-center">
            <p className="text-gray-400 mb-6 text-lg">
              Satın almak için Discord sunucumuza katılın
            </p>
            <a 
